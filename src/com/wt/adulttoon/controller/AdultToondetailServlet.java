...
@WebServlet("/adulttoondetail")
public class AdultToondetailServlet extends HttpServlet{
	...
	RequestDispatcher rd = request.getRequestDispatcher("/html/adulttoon/adulttoondetail.jsp");
