			...
			<table summary="글쓰기 전체 테이블">
				<c:choose>
					<c:when test="${empty list}">
						<form name="BoardWriteForm" method="post" action="${pageContext.request.contextPath}/adulttooninsert" 
																	enctype="multipart/form-data">
					</c:when>
					<c:otherwise>
						<form name="BoardWriteForm" method="post" action="${pageContext.request.contextPath}/adulttoonupdate" 
																	enctype="multipart/form-data">
					</c:otherwise>
				</c:choose>
			   		<colgroup>
					...
					<c:choose>
			    		...
			    		<tr>
			     			<td colspan="2"><div align="center">
			    	     		...
			    	     		<input type="button" value="뒤로" onclick="location.href='${pageContext.request.contextPath}/adulttoonlist'"></div>
			     			</td>
			    		</tr> 
					</table>
				</form> 
